# this program is to find lines with repeated SPn in output
# before running fill.py
# Mainly it is becaues fill.py will cause system crush, somehow...


from collections import OrderedDict
import csv
inputfile = "output_unfilled.csv"
